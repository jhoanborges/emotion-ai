                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            @auth
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ url('/facebook/posts') }}">who am I?</a>
                                </li>
                            @else
                            <li class="nav-item"><a class="nav-link" href="{{ url('/login') }}">Login</a></li> @endauth
                        </ul>
                    </div>
                </div>
            </nav>
                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                    <div class="text-uppercase">Detection &middot; Prevention &middot; Emotion</div>
                                </div>
                                <div class="fs-3 fw-light text-muted">I can help you to </div>
                                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">be aware of
                                        what social networks could know about you</span></h1>
                                <div
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-light mb-4">My name is Jhoan Borges.</p>
                                <p class="text-muted">Founder of <a href="https://hexagun.mx"
                                        target="_blank">Hexagun</a> and a student at Utel University
                                </p>
                                <p class="text-muted">I'm Passionate about the projects he undertakes, especially those
                                    involving challenges where technological innovation plays a key role and where they
                                    demand the use of research techniques and computer and systems. Proactive and with
                                    facility for rapid learning in the face of constant changes in technology.</p>
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient"
                                        href="https://www.linkedin.com/in/jhoan-borges-368578147/" target="_blank"><i
                                            class="bi bi-linkedin"></i></a>
                                    <a class="text-gradient" href="https://github.com/jhoanborges" target="_blank"><i
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <div class="small m-0">Copyright &copy; Emotion-AI 2024</div>
                    </div>
                    <div class="col-auto">
                        <a class="small" href="https://hexagun.mx/privacy" target="_blank">Privacy</a>
                        <span class="mx-1">&middot;</span>
                        <a class="small" href="https://hexagun.mx/terms-and-conditions" target="_blank">Terms</a>
                        <span class="mx-1">&middot;</span>
                        <a class="small" href="https://hexagun.mx/contactus" target="_blank">Contact</a>
                    </div>
                </div>
            </div>
        </footer>
